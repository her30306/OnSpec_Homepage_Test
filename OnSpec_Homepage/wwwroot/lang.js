...
var TRANSLATIONS = {
    ko: {
        ...
        /* ── index.html ── */
        'hero-badge':         'Vision Inspection Technology',
        ...
        'stat-years':         '년 축적 경험',
        'stat-fields':        '핵심 사업 분야',
        'stat-ai':            '딥러닝 검사 기술',
        'stat-solution':      '맞춤형 검사 솔루션',
        'overview-eyebrow':   '사업분야',
        'overview-h2':        '핵심 사업 분야',
    ...
    en: {
        ...
        'stat-fields':        'Core Business Areas',
        'stat-ai':            'Deep Learning Inspection',
        'stat-solution':      'Custom Inspection Solution',
        'overview-eyebrow':   'Business Areas',
        'overview-h2':        'Our Solutions',
